...
// Display any errors from save_profile.php
if (isset($_SESSION['profile_update_error'])) {
    echo '<div class="alert alert-danger">' . $_SESSION['profile_update_error'] . '</div>';
            ...
            <div id="profile" class="tab-content">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="mname" class="form-control" value="<?php echo isset($row['middle_name']) ? htmlspecialchars($row['middle_name']) : ''; ?>" required>
                    </div>
                    <div class="col-md-4 mb-3">
