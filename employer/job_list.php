...
$query = "SELECT id, job_title, company_name, salary, vacant, work_location FROM job_post WHERE employer_id = $employerid ORDER BY date_posted DESC LIMIT $start, $limit";
