...
$totalQuery = "SELECT COUNT(id) AS total FROM current_employee WHERE employer_id = $employerid AND gender = 'Male'";
...
$query = "SELECT * FROM current_employee WHERE employer_id = $employerid AND gender = 'Male' ORDER BY lname ASC LIMIT $start, $limit";
